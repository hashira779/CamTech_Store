                  ...
                  <div key={order.id} className="bg-white p-5 rounded-3xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 space-y-4">
                    ...
                    <div className="flex items-center gap-3 pt-2">
                      <Button
                        ...
                        className="flex-1 py-6 rounded-full bg-[#FDCB82] hover:bg-[#fab75b] text-amber-950 font-bold text-sm shadow-sm"
                      >
                        Accept & Route
                      </Button>
                    </div>
              ...
              activeOrders.length === 0 ? (
                ...
                activeOrders.map((order) => (
                  <div key={order.id} className="bg-white p-5 rounded-3xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-slate-100 space-y-4">
                    ...
                    <div className="flex items-center gap-3 pt-2">
                      <a href={`tel:${order.recipientPhone}`} className="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center border border-slate-200 text-slate-700 shrink-0">
                         <Phone className="w-5 h-5" />
                      </a>
                      {order.status === 'DISPATCHED' ? (
                        <Button
                          onClick={() => updateStatusMutation.mutate({ id: order.id, status: 'IN_TRANSIT' })}
                          className="flex-1 h-12 rounded-full bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm shadow-sm"
                        >
                          Start Navigation
                        </Button>
                      ) : (
                        <Button
                          ...
                          className="flex-1 h-12 rounded-full bg-[#FDCB82] hover:bg-[#fab75b] text-amber-950 font-bold text-sm shadow-sm"
                        >
                          Deliver & Sign
                        </Button>
                      )}
