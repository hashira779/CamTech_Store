...
export default function CustomerPortalPage() {
  ...
  const pastOrders = [
    {
      ...
      trackingNumber: 'TRK-2026-881294',
      date: '2026-09-02',
      total: 142.50,
      status: 'DELIVERED',
      items: ['AirPods Pro (2nd Gen) x1', 'USB-C Fast Charger x1'],
    },
    {
      id: 'ord_102',
      orderNumber: '#ORD-8519',
      trackingNumber: 'TRK-2026-910482',
      date: '2026-09-03',
      total: 89.00,
      status: 'IN_TRANSIT',
  ...
  const invoices = [
    { id: 'inv_01', number: 'INV-2026-00412', date: '2026-09-02', amount: 142.50, status: 'PAID' },
    { id: 'inv_02', number: 'INV-2026-00438', date: '2026-09-03', amount: 89.00, status: 'PAID' },
  ];
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-1">
                ...
                <div className="text-2xl font-black text-cyan-400">3,450 pts</div>
                <p className="text-[11px] text-slate-400">Equal to $34.50 store credit discount</p>
              </div>

              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-1">
                <span className="text-[10px] text-slate-400 font-semibold">Lifetime Spend</span>
                <div className="text-2xl font-black text-emerald-400">$1,820.50</div>
              ...
              <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 space-y-1">
                ...
                <div className="text-2xl font-black text-amber-400">Free Express</div>
