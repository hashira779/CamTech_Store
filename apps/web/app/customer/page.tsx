...
export default function CustomerPortalPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      {/* ─── Customer Header ─── */}
      <header className="bg-card/90 border-b border-border backdrop-blur-md sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-primary flex items-center justify-center text-foreground shadow-lg">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              className="h-8 px-3 text-xs bg-primary hover:bg-primary/90 text-foreground rounded-xl gap-1.5"
            >
      ...
      <section className="bg-card border-b border-border py-6 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 bg-card p-3 rounded-2xl border border-primary/30 shadow-md">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-6 flex-1 w-full">
        ...
        {activeTab === 'orders' && (
          <div className="space-y-4">
            ...
            {pastOrders.length === 0 ? (
              <div className="p-12 text-center rounded-2xl bg-card/60 border border-border">
                ...
                <Button
                  size="sm"
                  onClick={() => navigate('/shop')}
                  className="bg-primary hover:bg-primary/90 text-foreground rounded-xl text-xs gap-1.5"
                >
              ...
              <div className="space-y-3">
                {pastOrders.map((ord: any) => (
                  <div
                    key={ord.id}
                    className="p-4 rounded-2xl bg-card border border-border space-y-3 shadow-md"
                  >
                    ...
                    <div className="p-3 rounded-xl bg-background border border-border/80 text-xs text-foreground">
        ...
        {activeTab === 'support' && (
          <div className="max-w-xl space-y-4">
            ...
            <form onSubmit={handleSupportSubmit} className="space-y-3 p-4 rounded-2xl bg-card border border-border">
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl bg-background border border-border p-3 text-xs text-slate-100 placeholder:text-muted-foreground focus:outline-none focus:border-primary"
                />
              </div>

              <Button type="submit" className="w-full bg-primary hover:bg-primary/90 text-foreground font-bold text-xs h-9 rounded-xl">
