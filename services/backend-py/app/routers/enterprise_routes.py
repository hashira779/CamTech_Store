    ...
    return [
        {
            ...
            "supplierName": "Cambodia Coffee Importers Ltd",
            "status": "APPROVED",
            "totalAmount": 1850.00,
            "currency": "USD",
    ...
    return [
        {
            ...
            "accumulatedDepreciation": float(a.accumulated_depreciation),
            "bookValue": float(a.book_value),
            "status": a.status
        } for a in assets
    ]
...
async def run_asset_depreciation(
    ...
    asset.accumulated_depreciation = calc["newAccumulated"]
    asset.book_value = calc["newBookValue"]
    await db.commit()
...
# ==============================================================================
# 21. DEVELOPER PLATFORM & API KEYS
# ==============================================================================
...
async def create_api_key(
    ...
    key_record = ApiKey(
        ...
        scopes=str(data.get("scopes", ["products:read"])),
    ...
    return {
        ...
        "rawKey": key_info["rawKey"],  # Returned only once on generation
        "status": key_record.status,
        "createdAt": key_record.created_at.isoformat()
    }

# ==============================================================================
# 22. TELEGRAM PLATFORM
# ==============================================================================
