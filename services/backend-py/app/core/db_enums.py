...
ENUM_LABELS: dict[str, list[str]] = {
    ...
    "StorageObjectStatus": ["PENDING", "AVAILABLE", "MIGRATING", "DELETED", "ERROR"],
    "StorageProviderStatus": ["CONNECTED", "CHECKING", "AUTH_REQUIRED", "ERROR", "DISABLED"],
    "StorageProviderType": ["LOCAL_S3", "GOOGLE_DRIVE", "AZURE_BLOB", "NAS"],
